        ...
        case "ru":
            ...
            patterns: {
                ...
                Y: "MMMM yyyy"
                 ...
                 pagershowrowsstring: "Показать линию:",
                 pagerrangestring: " от ",
                 pagerpreviousbuttonstring: "следующий",
                 pagernextbuttonstring: "предыдущий",
                 pagerfirstbuttonstring: "первый",
                 pagerlastbuttonstring: "последний",
                 groupsheaderstring: "Перетащите столбец и поместите его сюда, чтобы группировать по данной колонке",
                 sortascendingstring: "Сортировать по возрастанию",
                 sortdescendingstring: "Сортировать по убыванию",
                 sortremovestring: "Удалить сортировки",
                 groupbystring: "Группа По этой колонке",
                 groupremovestring: "Remove from groups",
                 filterclearstring: "Удалить",
                 filterstring: "Фильтр",
                 ...
                 //    'nicht enthalten', 'nicht enthalten(gu)', 'beginnt mit', 'beginnt mit(gu)',
                 //    'endet mit', 'endet mit(gu)', 'equal', 'gleich(gu)', 'null', 'nicht null'],
                filterstringcomparisonoperators: ['пустой', 'еще не', 'содержит', 'содержит (гу)', 'не', 'не включено (гу)','начинается с', 'начинается с (гу)',
                     'заканчивается', 'заканчивается (гу)','равна','равен (ГУ)','нулевой','не ноль'],
                 filternumericcomparisonoperators: ['gleich', 'nicht gleich', 'weniger als', 'kleiner oder gleich', 'größer als', 'größer oder gleich', 'null', 'nicht null'],
                 filterdatecomparisonoperators: ['gleich', 'nicht gleich', 'weniger als', 'kleiner oder gleich', 'größer als', 'größer oder gleich', 'null', 'nicht null'],
                 filterbooleancomparisonoperators: ['gleich', 'nicht gleich'],
                 validationstring: "Введенное значение не является допустимым",
                 emptydatastring: "Нет данных",
                 filterselectstring: "Выбор фильтра",
                 loadtext: "Загрузка...",
                 clearstring: "Удалить",
                 todaystring: "Сегодня"
             }
